<%-- 
    ...
    Created on : May 17, 2024, 10:29:52 AM
    Author     : frank
--%>
...
{
    String uq = "insert into tbl_complaint set complaint_content = '"+request.getParameter("complaint_content")+"'"+ ",complaint_date =curdate() ,agency_id = '"+session.getAttribute("agid")+"'";
         ...
         <form method="post" >
              ...
              <h2 align="center">COMPLAINT</h2>
                    ...
                    <div class="formbold-mb-3">
                        <textarea name="complaint_content" placeholder="Enter Complaint" class="formbold-form-input" required></textarea>
                    </div>   
