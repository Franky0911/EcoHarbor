<%-- 
    Document   : nea
    Created on : May 22, 2024, 9:05:39 AM
    Author     : frank
--%>
        ...
        <div class="containers">
            <div class="profile-box">
                <div class="profile-image">
                    <img src="../Assets/Files/UserPhoto/<%=rsu.getString("user_photo")%>" alt="Profile Image">
                </div>
                <div class="profile-details">
                    <div>Name   : <%=rsu.getString("user_name")%></div>
                    <div>Contact: <%=rsu.getString("user_contact")%></div>
                    <div>Email  : <%=rsu.getString("user_email")%></div>
                    <div>Address:     <%=rsu.getString("user_address")%></div>
                </div>
            </div>
            <%
                }
