<%-- 
    ...
    Created on : May 16, 2024, 1:52:11 PM
    Author     : frank
--%>
    ...
    <div class="container-fluid">
      ...
      <h2>TRANSACTION HISTORY</h2>
        ...
        <table border="1" align="center">         
            ...
            <tr>
    <%
                       String sq = "select*from tbl_transaction t inner join tbl_user u on t.user_id = u.user_id where u.user_id ='" + session.getAttribute("uid") + "'";
