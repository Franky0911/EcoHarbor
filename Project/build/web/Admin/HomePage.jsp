    ...
    <div class="container-fluid">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li><a href="AgencyRegistration1.jsp">Agency Registration</a></li>
          ...
          <div class="carousel-item active" style="background-image: url('../Assets/Templates/Main/img/intro-carousel/e2.jpg');"">
            <div class="carousel-container">
              <div class="carousel-content">
                <h2>Hello <%=session.getAttribute("adname")%></h2>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app wow fadeInUp" data-wow-delay="0.2s">
            <div class="portfolio-wrap">
              <figure>
                ...
                <a href="TransactionHistory.jsp" class="link-details" title="More Details"><i class="ion ion-android-open"></i></a>
              </figure>
              <div class="portfolio-info">
                <h4><a href="TransactionHistory.jsp">TRANSACTION HISTORY</a></h4>
              </div>
            </div>
          </div>
