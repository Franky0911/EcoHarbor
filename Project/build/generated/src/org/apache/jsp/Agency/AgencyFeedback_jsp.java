...
public final class AgencyFeedback_jsp extends org.apache.jasper.runtime.HttpJspBase
...
+ ",feedback_date =curdate() ,agency_id = '"+session.getAttribute("agid")+"'";
if(con.executeCommand(uq)){ 
      ...
      out.write("                        <textarea name=\"feedback_content\" placeholder=\"Enter Feedback Content\" class=\"formbold-form-input\" required></textarea>\n");
      out.write("                    </div>   \n");
