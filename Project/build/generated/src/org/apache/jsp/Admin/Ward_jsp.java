...
public final class Ward_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if (rs.getString("location_id").equals(editlid)) {
      ...
      out.write("                    </select>\n");
      out.write("                    </div>\n");
      out.write("                    <label class=\"formbold-form-label\">Ward Number</label>\n");
      ...
      out.write("</td>\n");
      out.write("                    <td><a class=\"choose-file-button\" href = \"Ward.jsp?did=");
      out.print(rs1.getString("ward_id"));
      out.write("\">Delete</a><a class=\"choose-file-button\" href = \"Ward.jsp?eid=");
      out.print(rs1.getString("ward_id"));
      out.write("\">Edit</a></td>\n");
      out.write("                </tr>   \n");
      out.write("                ");
