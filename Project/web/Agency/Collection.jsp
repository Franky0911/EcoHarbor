<%-- 
    Document   : Collection
    Created on : Feb 26, 2024, 5:10:08 PM
    Author     : frank
--%>
    ...
    <%
        ...
        if (request.getParameter("txtsave") != null) {
            ...
            while (rsz.next()) {
                ...
                while (rs2z.next()) {
                    String updString = "update tbl_requesttype set requesttype_quantity='" + request.getParameter(rs2z.getString("wastetype_id")) + "' where requesttype_id='" + rs2z.getString("requesttype_id") + "'";
