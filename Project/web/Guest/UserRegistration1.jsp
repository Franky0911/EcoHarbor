            ...
            <div class="formbold-form-wrapper">
                <form method="POST" enctype="multipart/form-data" action="../Assets/ActionPages/UserUploadAction.jsp">    
                    ...
                    <div class="formbold-mb-3">
                        ...
                        <input type="text" class="formbold-form-input" placeholder="Enter phone number" name="txtcontact" pattern="[7-9}{1}[0-9]{9}" title="Phone number with 7-9 and remaining 9 digits with 0-9"  required />
                    </div>
                    <div class="formbold-mb-3">
                    ...
                    <div class="formbold-mb-3">
                        ...
                        <input type="text" class="formbold-form-input" placeholder="Enter Property No" name="txtpropno" required />
                    </div> 
                    <div class="formbold-input-flex">
                        ...
                        <div>
                            <select name="ddlWard" id="selward" class="formbold-form-input" required>
                                <option value="" hidden>Ward No</option>
                            </select>
                        </div>
                    </div>    
                    <div class="formbold-mb-3">
