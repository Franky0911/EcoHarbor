<%-- 
    Document   : AgencyUploadAction
    Created on : Jan 4, 2024, 1:56:01 PM
    Author     : frank
--%>
...
//checking if request cotains multipart data
           ...
           //f_item=(FileItem)itr.next();
                        ...
                        if (field_name.equals("txtlfile")) {
                            ...
                            String file_path = proj_path.getParentFile().getParentFile().getPath() + "\\web\\Assets\\Files\\AgencyLogo\\";
                            Random r = new Random();
                        ...
                        if (field_name.equals("txtpfile")) {
                            ...
                            //setting path to store image
                            File proj_path = new File(config.getServletContext().getRealPath("/"));
                            String file_path = proj_path.getParentFile().getParentFile().getPath() + "\\web\\Assets\\Files\\AgencyProof\\";
                            Random r = new Random();
                            int r_num = r.nextInt(1111) + 999;
